...
def convert_row(raw):
    return {
        ...
        "contact_name": raw.get("Contact") or raw.get("Contact Name") or raw.get("contact_name") or "",
        "contact_email": raw.get("Contact Email") or raw.get("contact_email") or "",
        "contact_phone": raw.get("Contact Phone") or raw.get("contact_phone") or "",
